...
void SetDefaultInterrupts(void)
{
	...
	USB0.BEMPENB.BIT.PIPE6BEMPE = 0;
	
	/*BRDY - enable only as required*/
	USB0.BRDYENB.BIT.PIPE6BRDYE = 0;
	
	/*Bulk IN pipe (pipe2)*/
	/*BEMP - enable only as required*/
	USB0.BEMPENB.BIT.PIPE2BEMPE = 0;
...
void usbPipeSetup(void)
{
	...
	{
		/*Select Pipe*/
		USB0.PIPESEL.BIT.PIPESEL = 6;
	
		/*Pipe Control*/
		/*Note: PID must be set to NAK before configuring PIPECFG*/
		USB0.PIPE6CTR.WORD = 0x000;
